...
Environment variables are made available to an application statically at build time, meaning that they do not update in the application unless it is redeployed.
