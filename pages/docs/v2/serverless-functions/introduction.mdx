...
export const meta = {
  ...
  lastEdited: '2019-10-02T19:08:43.000Z'
}
...
If this behavior is not desired, for example you want a utilities folder inside of the `/api` directory, you can prefix either files or folders with `_` to prevent them from being created as Serverless Functions.
