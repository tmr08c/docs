...
export const meta = {
  ...
  lastEdited: '2019-10-02T19:03:29.000Z'
}
...
If this behavior is not desired, for example you want a utilities folder inside of the `/api` directory, you can prefix either files or folders with `_` to stop them being created as Serverless Functions.
